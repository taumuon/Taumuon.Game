...
{
public:
	Direct3DContentProvider(Taumuon::Game::Renderer::Direct3DBackground^ controller);
...
private:
	Taumuon::Game::Renderer::Direct3DBackground^ _controller;
	Microsoft::WRL::ComPtr<IDrawingSurfaceRuntimeHostNative> _host;
};